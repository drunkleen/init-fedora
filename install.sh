...
echo "-----------------------------\n"
read -p "Press Enter to continue..."
sudo dnf install -y zsh vlc neovim fzf neofetch gnome-tweaks gnome-themes-extra btop git golang inkscape xorg-x11-apps wget
...
sudo cp -r /home/$USER/Downloads/init-fedora/src/Desert-Brown-Dark-1.3 /home/$USER/.themes/
